...
def insert_fake_data(engine, num_providers=8, num_patients=100, num_medications=20, num_patient_medications=150, num_demographics=20):
    ...
    with engine.connect() as connection:
        ...
        for _ in range(num_patients):
            ...
            query = text("INSERT INTO patients (first_name, last_name, date_of_birth, primary_provider_id) VALUES ""(:first_name, :last_name, :date_of_birth, :primary_provider_id)")
            connection.execute(query, {"first_name": first_name, "last_name": last_name, "date_of_birth": date_of_birth, "primary_provider_id": primary_provider_id})
